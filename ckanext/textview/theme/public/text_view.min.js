...
self.el.html(highlighted);},error:function(jqXHR,textStatus,errorThrown){if(textStatus=='error'&&jqXHR.responseText.length){self.el.html('<p>Les données ne peuvent être visualisées.<br>Elles sont disponibles pour le téléchargement par le bouton Télécharger ci-haut. <br>Pour tout problème avec ce jeu de données, veuillez  <a href="./../../../../../fr/contact">communiquez avec nous</a></p>');}else{self.el.html(self.i18n('error',{text:textStatus,error:errorThrown}));}}});}};});
