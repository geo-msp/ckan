  ...
  <div class="editor"> \
    <form class="form-stacked"> \
      ...
      <div class="editor-buttons"> \
        <button class="btn btn-default editor-add">Ajouter une série</button> \
      </div> \
...
my.MapMenu = Backbone.View.extend({
  ...
  template: ' \
    <form class="form-stacked"> \
      <div class="clearfix"> \
        <div class="editor-field-type"> \
            <label class="radio"> \
              ...
              Champs : Latitude / Longitude</label> \
            <label class="radio"> \
              <input type="radio" id="editor-field-type-geom" name="editor-field-type" value="geom" /> \
              Champs : GeoJSON</label> \
        </div> \
        <div class="editor-field-type-latlon"> \
          <label>Champs Latitude</label> \
        ...
        <div class="editor-field-type-geom" style="display:none"> \
          <label>Champs de la géométrie (GeoJSON)</label> \
      ...
      <div class="editor-buttons"> \
        <button class="btn btn-default editor-update-map">Mettre à jour</button> \
      </div> \
...
my.MultiView = Backbone.View.extend({
  ...
  initialize: function(options) {
    ...
    this.listenTo(this.model, 'query:done', function() {
      ...
      self.$el.find('.doc-count').text(self.model.recordCount || 'Aucun');
    });
...
my.GridControl= Backbone.View.extend({
  ...
  template: '<h1><button href="#" class="recline-row-add btn btn-default">Ajouter une rangée</button></h1>',
      ...
      <form class="form-stacked js-add" style="display: none;"> \
        ...
        <div class="form-group"> \
          ...
          <select class="filterType form-control"> \
            <option value="term">Valeur</option> \
            <option value="range">Écart</option> \
            <option value="geo_distance">Distance géographique</option> \
          </select> \
        </div> \
    ...
    range: ' \
      <div class="filter-{{type}} filter"> \
        <fieldset> \
          ...
          <div class="form-group"> \
            <label class="control-label" for="">De</label> \
  ...
  template: ' \
    <div class="pagination"> \
      <ul class="pagination"> \
        ...
        <li class="page-range"><a><label for="from">De</label><input id="from" name="from" type="text" value="{{from}}" /> &ndash; <label for="to">à</label><input id="to" name="to" type="text" value="{{to}}" /> </a></li> \
    ...
    <form action="" method="GET" class="form-inline" role="form"> \
      <div class="form-group"> \
        <div class="input-group text-query"> \
          ...
          <input class="form-control search-query" type="text" id="q" name="q" value="{{q}}" placeholder="Recherche ..."> \
        </div> \
      </div> \
